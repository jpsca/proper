...
class RequestForgeryProtection(Concern):
    ...
    def _handle_verified_request(self) -> str:
        ...
        # The ` or ""` is to satisfy type checkers that session_token is always a
        # string, even though it should never be `None` at this point.
