...
class RateLimiting(Concern):
    ...
    Requests that exceed the rate limit will raise a `proper.errors.TooManyRequests`
    ...
    Args:
        ...
        react_with:
            ...
            If `None`, a `proper.errors.TooManyRequests` error is raised.
        scope:
    ...
    rate_limit: "dict | list[dict] | None" = None
    ...
    def _set_rate_limit(self):
        if self.rate_limit:
            for opts in make_list(self.rate_limit):
