...
app = Proxy(_current_app.get, _current_app.set)
request = Proxy(_current_request.get, _current_request.set)
response = Proxy(_current_response.get, _current_response.set)
