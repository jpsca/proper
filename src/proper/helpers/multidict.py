import typing as t
from collections.abc import ItemsView, Iterable, KeysView, Mapping, MutableMapping


__all__ = ("MultiDict",)

TDictOrIter = Mapping[str, t.Any] | Iterable[tuple[str, t.Any]]
...
class MultiDict(MutableMapping):
    ...
    def __getitem__(self, key: str):
        # Return the last scalar value, mirroring `.get()`. This keeps `[]`
    ...
    def get(
        ...
        *,
        ...
        possible, so the function can return the default as if the key was not
        found.
