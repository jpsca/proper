...
class I18n(Formatters):
    ...
    def lazy_translate(self):
        ...
        class LazyWrapper:
            ...
            def __repr__(self):
                return translate(self.args[0], self.args[1], **self.kwargs)
    ...
    def translate(
        ...
        **kwargs,
        ...
        is tried instead. If that doesn't exist either, an empty string is
        returned.
        ...
        Arguments:
            ...
            count:
                ...
                a 'n' key is tried instead. If that doesn't exist either, an
    ...
    def _pluralize(self, dic: dict, *, locale: str, count: int = 1):
        ...
        a. that number
        b. the value for "zero" if exists and the number is 0
        ...
        Finally, if none of these exist, an empty string is returned.
