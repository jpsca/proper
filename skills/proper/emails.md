...
class WelcomeEmail(EmailMessage):
    ...
    def __init__(self, user, **kwargs):
        ...
        # No need to set self.body — send() will render the template automatically
```


## The BaseEmail Pattern
