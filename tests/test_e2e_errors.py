...
def test_fallback_error(app):
    app.router.get("fail/not_acceptable")(Pages.fail_not_acceptable)
    app.router.get("fail/not_implemented")(Pages.fail_not_implemented)
    app.router.get("fail/forbidden")(Pages.fail_forbidden)
...
def test_custom_register_not_an_exception(app):
    ...
    with pytest.raises(AssertionError):
        app.router.error(NotAnException)(Pages.custom_not_found_handler)


def test_custom_register_not_even_a_class(app):
    with pytest.raises(AssertionError):
        app.router.error(5)(Pages.custom_not_found_handler)
...
def test_custom_error_handlers(app):
    ...
    app.router.error(errors.NotFound)(Pages.custom_not_found_handler)
    app.router.error(errors.NotAcceptable)(Pages.custom_not_acceptable_handler)
    app.router.error(errors.HTTPError)(Pages.custom_error_handler)
