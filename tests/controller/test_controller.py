...
class TestParams:
    ...
    def test_returns_cached_multidict(self):
        co = _make_controller()
...
class TestRender:
    ...
    def test_render_template(self):
        ...
        result = co.render("my_template.jx")
...
class TestRedo:
    def test_redo_on_update_renders_edit(self):
        class PostsController(Controller):
            __module__ = "myapp.pages.posts"
...
class TestCall:
    ...
    def test_falls_back_to_application_prefix(self):
        class ApplicationController(Controller):
            __module__ = "myapp.pages.application_controller"
...
class TestStaticFilesController:
    ...
    def test_path_traversal_blocked(self, tmp_path):
        """Requests with '..' must not escape the static root."""
        secret = tmp_path.parent / "secret.txt"
        secret.write_text("top secret")
        try:
            co, _ = self._make(tmp_path, file_param="../secret.txt")
