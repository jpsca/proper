...
from .plug_load_user import PlugLoadUser
from .plug_protect import PlugProtect


__all__ = ("DEFAULT_HASHER", "VALID_HASHERS", "WrongHashAlgorithm", "AuthManager")
...
Authcode can *read* many hash methods but, for security reasons,
...
class AuthManager(object):
    ...
    def load(self, *args, **kwargs):
        return PlugLoadUser(*args, **kwargs)

    def login_required(self, *args, **kwargs):
        return PlugProtect(*args, **kwargs)
